<div class="row">
    ...
    <div class="col-md-6" style="background:white; border-radius:5px; box-shadow: 3px 3px 5px gray;">
        <form name ="price_form" method="post" action="<?php echo ROOT_URL;?>transaction/majorExpense">
            <div class="row">
                <div class="modal-header">
                    <h4 class="modal-title">Major Expenses</h4>
                </div>
            </div><br>
            <div class="row" style="display:flex; justify-content:center;">
                <div class="col-md-12" style="display:flex; justify-content:center;">
                    <div class="input-group input-group-sm">
                        <span class="input-group-addon" style="width:180px;">From Which Account</span>
                        <select class="form-control input-sm"  name="account_type" style="width:320px;" required>
                            ...
                            <?php
                            foreach($data as $row)
                                echo '<option value="'.$row["account_desc"].'">'.$row["account_desc"].'</option>';
                            ?>
                        </select>
                    </div>
                </div>
            ...
            <div class="row" style="display:flex; justify-content:center;">
                <div class="col-md-12" style="display:flex; justify-content:center;">
                    <div class="input-group input-group-sm">
                        <span class="input-group-addon" style="width:180px;">Expense Detail</span>
                        <input class="form-control input-sm" placeholder="e.g Diesel For The Yard or From Project Maneger" autocomplete="off" type="text" name="trans_desc" value="<?php echo isset($_POST['trans_desc']) ? $_POST['trans_desc'] : '';?>" style="width:320px;" required/>
                    </div>
                </div>
            </div>
            <div class="row" style="display:flex; justify-content:center;">
                <div class="col-md-12" style="display:flex; justify-content:center;">
                    <div class="input-group input-group-sm">
                        <span class="input-group-addon" style="width:180px;">Amount Used</span>
                        <input class="form-control input-sm" placeholder="e.g 5000.50" autocomplete="off" type="text" name="trans_amount" value="<?php echo isset($_POST['trans_amount']) ? $_POST['trans_amount'] : '';?>" style="width:320px;" required/>
                    </div>
                </div>
            </div>
            <br>
